...
L.en.slash_msg = "|cffFFD100[Midnight]|r Type /mot to open the objective tracker."
L.en.welcome_title = "Midnight Objective Tracker"
L.en.welcome_msg = "Type |cffFFD100/mot|r in the chat to open the objective tracker."
